...
function updateClock(now) {
  ...
  elDate.textContent = now
    .toLocaleDateString(uiLocale(), { weekday: 'long', day: 'numeric', month: 'long' })
    .replace(',', '')
    .toUpperCase();
}
...
const MOCK_BRIEFING_LINES = [
  ...
  'Weather: 14° · partly cloudy, no rain expected.',
  'Agenda: 4 items — stand-up, design review, 1:1, focus block.',
  'Mail: 12 unread · 2 flagged urgent (mock).',
  'Work: 4 open PRs — 1 ready for review, 1 draft.',
  'System: brain online · desk idle · all green.',
];
